...
console.log('Queen-Nethu-MD Installing plugins ✅')
const path = require('path');
...
console.log('Queen-Nethu-MD Plugins installed ✅')
await connectdb()
await updb()
...
externalAdReply: { 
title: '𝗤𝘂𝗲𝗲𝗻-𝗡𝗲𝘁𝗵𝘂 𝗠𝗗 💚',
body: 'ᴀ ꜱɪᴍᴘʟᴇ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ',
mediaType: 1,
sourceUrl: "https://www.youtube.com/@SlNethuMax" ,
thumbnailUrl: 'https://i.ibb.co/D7fhPb1/6071.jpg' ,
...
app.get("/", (req, res) => {
  res.send("Queen-Nethu-MD Working successfully ✅");
});
